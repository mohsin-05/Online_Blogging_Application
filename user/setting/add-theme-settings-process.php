...
if (isset($_POST['add_setting'])) {
	...
	$query = "INSERT INTO setting (user_id, setting_key, setting_value, setting_status, created_at) VALUES ('".$_SESSION['user_id']."', '".$setting_key."', '".$setting_value."', 'Active', '".$created_at."')";
	$result = mysqli_query($connection, $query);
	if ($result) {
		header("location:../".$page."?setting_msg=Setting Added Successfully&color=success&post_id=".$post_id."&blog_id=".$blog_id."&category_id=".$category_id."");
	} else {
