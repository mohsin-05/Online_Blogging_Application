      ...
      <div class="container-fluid">
        <div class="row ps-5">
          <div class="col-md-4 col">
            <form class="d-flex my-5" role="search" action="admin.php" method="GET">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
          ...
          if (isset($_GET['page']) && $_GET['page'] > 0) { ?>
            <li class="page-item">
              <a class="page-link" href="admin.php?page=<?php echo ($_GET['page']) - 1; echo (isset($_GET['search_value'])) ? "&search_value=".$_GET['search_value']."" : ""; ?>">
                Previous
              </a>
            </li>
          <?php }
          ...
          for ($i = 1; $i <= $total_links; $i++) { ?>
            <li class="page-item"><a class="page-link" href="admin.php?page=<?php echo $i - 1; echo (isset($_GET['search_value'])) ? "&search_value=".$_GET['search_value']."" : ""; ?>"><?php echo $i; ?></a></li>
          <?php }

          if (isset($_GET['page']) && $_GET['page'] + 1 != $total_links) { ?>
            <li class="page-item"><a class="page-link" href="admin.php?page=<?php echo ($_GET['page']) + 1; echo (isset($_GET['search_value'])) ? "&search_value=".$_GET['search_value']."" : ""; ?>">Next</a></li>
          <?php } ?>
        </ul>
      </nav>
